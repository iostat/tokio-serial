...
impl Serial {
        ...
        P: AsRef<Path>,
    {
        ...
        #[cfg(windows)]
        let io = unsafe { named_pipe::NamedPipeClient::from_raw_handle(inner.as_raw_handle())? };
...
impl AsyncRead for Serial {
    fn poll_read(
        ...
        #[cfg(windows)]
        return io_pin.poll_read(cx, buf);
...
impl AsyncWrite for Serial {
    fn poll_write(
        ...
        #[cfg(windows)]
        return io_pin.poll_write(cx, buf);
